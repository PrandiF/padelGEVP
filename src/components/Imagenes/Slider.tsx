    ...
    <div className="hidden xl:flex xl:flex-col xl:w-full sm:w-full mx-auto relative">
      <div className="w-full relative">
        <Swiper
          ...
          className="h-[25rem] w-full flex items-center justify-center mx-auto"
          data-aos="fade-up"
          data-aos-delay="400"
        >
          {TenisPics.map((item, index) => (
            ...
            >
              <img
                src={item.url}
                alt="slide_image"
                className="w-full h-[25rem] rounded-xl object-cover bg-transparent flex items-center justify-center"
              />
            </SwiperSlide>
          ))}
        </Swiper>
